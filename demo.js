...
var _reactJsonView = __webpack_require__(/*! react-json-view */ "./node_modules/react-json-view/dist/main.js");
...
var PropsEditor = function (_Component) {
  ...
  function PropsEditor(props) {
    ...
    var _this = _possibleConstructorReturn(this, (PropsEditor.__proto__ || Object.getPrototypeOf(PropsEditor)).apply(this, arguments));

    _this.state = Object.assign({}, _this.props.children.props, props);
    delete _this.state.children;
    return _this;
  }

  _createClass(PropsEditor, [{
    key: 'onEdit',
    value: function onEdit(_ref) {
      var updated_src = _ref.updated_src;
      ...
      var newState = Object.keys(this.state).reduce(function (acc, key) {
        acc[key] = undefined;
        return acc;
      }, {});
    ...
    value: function render() {
      var Children = this.props.children.type;
      var onEdit = this.onEdit.bind(this);

      return _react2.default.createElement(
        _react.Fragment,
        null,
        _react2.default.createElement(Children, this.state),
